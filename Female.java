...
public class Female extends Person {
	...
	float calculateEnergyRequirement() {
		...
		if(this.age<AgeGroupEnum.MAX_AGE_3Y.getAge()) {
			...
			energyRequirement = (float)( (135.3 - (30.8* this.age)) + (this.physicalActivityLevel*(10*this.weight + 934*this.height/100)) + 20); 
		}
		else if (this.age<AgeGroupEnum.MAX_AGE_ABOVE.getAge()){
			energyRequirement = (float)( (354 - (6.91* this.age)) + (this.physicalActivityLevel*(9.36*this.weight + 726*this.height/100)));
		}
